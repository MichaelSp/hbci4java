...
public class UpdateBLZProperties {
    private final static Charset CHARSET_INPUT = Charset.defaultCharset();
    private final static Charset CHARSET_OUTPUT = Charset.defaultCharset();

    /**
     * @param args 1. Pfad/Dateiname zu "fints_institute.csv". 2. Pfad/Dateiname
