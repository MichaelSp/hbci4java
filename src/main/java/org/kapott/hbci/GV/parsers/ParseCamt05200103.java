...
import org.kapott.hbci.sepa.jaxb.camt_052_001_03.*;
 ...
 */
public class ParseCamt05200103 extends AbstractCamtParser {
    /**
     ...
     */
    private BTag createDay(AccountReport12 report) {
        BTag tag = new BTag();
        tag.start = new Saldo();
        tag.end = new Saldo();
        tag.starttype = 'F';
